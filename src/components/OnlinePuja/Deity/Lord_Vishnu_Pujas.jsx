...
const Lord_Vishnu_Pujas = () => {
  const pujas = [
    {
      title: "Satyanarayan Puja",
      desc: "A sacred puja performed for prosperity, happiness, and fulfilling wishes.",
      amount: "₹1001",
    },
    {
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
          Perform sacred pujas dedicated to Lord Vishnu to bring peace,
...
export default Lord_Vishnu_Pujas;
