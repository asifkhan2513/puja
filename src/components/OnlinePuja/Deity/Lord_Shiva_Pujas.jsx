...
const Lord_Shiva_Poojas = () => {
  const Poojas = [
    {
      title: "Rudrabhishek Pooja",
      desc: "A powerful Pooja offered to Lord Shiva for peace, prosperity, and removal of negativity.",
      amount: "₹1201",
    },
    {
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
          Invoke the divine energy of Mahadev through sacred Poojas performed by
...
export default Lord_Shiva_Poojas;
