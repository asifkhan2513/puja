...
const Ayodhya_Temple_Poojas = () => {
  const Poojas = [
    {
      title: "Shri Ram Abhishek Pooja",
      desc: "A sacred ritual performed at Ayodhya for blessings, peace, and spiritual upliftment.",
      amount: "₹1501",
    },
    {
      title: "Ram Janmabhoomi Darshan Pooja",
      desc: "Offer special prayers at the holy birthplace of Bhagwan Shri Ram.",
      amount: "₹1101",
    },
    {
      title: "Hanuman Garhi Pooja",
      desc: "Dedicated Pooja seeking protection and strength from Bajrang Bali.",
      amount: "₹901",
    },
  ];
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-amber-900 text-center mb-10">
          Ayodhya Temple Poojas
        </h2>

        <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
          Perform sacred Poojas in Ayodhya, the holy birthplace of Bhagwan Shri
          Ram. Seek divine blessings, peace, protection, and spiritual
          upliftment.
        </p>
...
export default Ayodhya_Temple_Poojas;
