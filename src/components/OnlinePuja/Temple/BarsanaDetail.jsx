...
const BarsanaDetail = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-pink-50 to-rose-100 font-sans scroll-smooth">
      {/* HERO SECTION */}
      <div
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 left-6 z-20 flex items-center gap-2 px-6 py-2 bg-white/20 backdrop-blur-md rounded-full text-white hover:bg-pink-600 hover:border-pink-600 border border-white/30 transition-all duration-300 font-bold tracking-wide shadow-lg cursor-pointer transform hover:scale-105"
        >
          ← Back
        </button>

        <div className="relative z-10 px-6 max-w-5xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-pink-400 to-rose-500 bg-clip-text text-transparent drop-shadow-2xl font-serif tracking-wide mb-6 animate-pulse">
            Barsana
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-14">
        {/* INTRO */}
        <p className="mt-6 text-xl text-gray-800 leading-loose font-medium max-w-4xl mx-auto text-center font-serif bg-white/70 p-8 rounded-3xl border border-pink-200 shadow-lg hover:shadow-xl transition-all duration-300">
          <span className="font-bold bg-gradient-to-r from-pink-600 to-rose-700 bg-clip-text text-transparent text-2xl">
            Barsana
          </span>{" "}
          is not just a town; it is a sacred pilgrimage site, famously known as
          the "Land of Radha Rani," and is considered one of the holiest places
          in all of India. This spot is completely steeped in the eternal and
        ...
        <div className="space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-700 to-rose-800 bg-clip-text text-transparent font-serif border-l-8 border-pink-500 pl-6">
          ...
          {/* IMAGE BREAK */}
          <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-pink-200 ring-2 ring-rose-300 transform hover:scale-105 transition-all duration-500">
            <img
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-pink-50 to-rose-100 p-6 rounded-2xl shadow-lg border border-pink-200 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border-l-4 border-l-pink-400">
              <p className="text-lg leading-loose text-gray-800 font-medium">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-pink-100 p-6 rounded-2xl shadow-lg border border-rose-200 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border-l-4 border-l-rose-400">
              <p className="text-lg leading-loose text-gray-800 font-medium">
                <span className="font-bold text-rose-700 block mb-2 text-xl">
                  Divine Worship
                </span>{" "}
        ...
        <div className="space-y-6 bg-gradient-to-br from-rose-50 to-pink-100 p-8 rounded-3xl border-2 border-rose-200 shadow-xl">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-700 to-pink-800 bg-clip-text text-transparent font-serif border-b-4 border-rose-300 pb-2 inline-block">
            The Hilltop Haven
          </h2>
          <p className="text-lg leading-loose text-gray-800 font-medium">
          ...
          <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-rose-300 ring-2 ring-pink-300 transform hover:scale-105 transition-all duration-500">
            <img
              src="https://media-cdn.tripadvisor.com/media/photo-s/12/2b/35/34/barsana-shri-radha-rani.jpg"
              alt="The Hilltop Haven"
              className="w-full rounded-3xl h-[80%] object-fit hover:scale-110 transition duration-700"
            />
          </div>
        </div>

        <div className="space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-700 to-rose-800 bg-clip-text text-transparent font-serif border-b-4 border-pink-300 pb-2 inline-block">
            Significance of The Hill
          </h2>
          <p className="text-lg leading-loose text-gray-800 font-medium bg-white/70 p-6 rounded-2xl border border-pink-200 shadow-lg">
        ...
        <div className="bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-3xl border-2 border-rose-200 shadow-xl">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-700 to-rose-800 bg-clip-text text-transparent font-serif mb-6">
            Architecture
          </h2>
        ...
        <div className="space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-700 to-rose-800 bg-clip-text text-transparent font-serif border-l-8 border-rose-400 pl-6">
            The Sacred Connection Between Villages
          </h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <ul className="list-none space-y-4 text-lg text-gray-800 font-medium">
              <li className="bg-gradient-to-br from-pink-50 to-white p-4 rounded-xl shadow-lg border border-rose-100 hover:shadow-xl transition-all duration-300">
                The epic love story of Radha and Krishna symbolizes the union of
                their respective homes:
              </li>
              <li className="pl-4 border-l-4 border-pink-300 bg-white/50 p-3 rounded-r-xl">
          ...
          <p className="text-lg leading-loose text-gray-800 font-medium bg-gradient-to-r from-rose-50 to-pink-50 p-6 rounded-2xl border-2 border-rose-200 shadow-lg">
        ...
        <div className="space-y-8 bg-gradient-to-br from-pink-50 to-rose-100 p-8 rounded-3xl border-2 border-pink-300 shadow-xl">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-rose-700 to-pink-800 bg-clip-text text-transparent font-serif border-b-4 border-rose-300 pb-2 inline-block">
          ...
          <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-rose-200 ring-2 ring-pink-300 transform hover:scale-105 transition-all duration-500">
            <img
          ...
          <div className="space-y-6 pt-6">
            ...
            <p className="text-lg leading-loose text-pink-800 font-bold bg-gradient-to-r from-pink-50 to-rose-50 p-6 rounded-xl border-2 border-pink-300 text-center shadow-lg">
