...
const Ujjain_Temple_Pujas = () => {
  const pujas = [
    {
      title: "Mahakaleshwar Bhasma Aarti Puja",
    ...
    {
      title: "Mahakaleshwar Abhishek Puja",
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-700 max-w-2xl mx-auto mb-12">
          ...
          most powerful Jyotirlingas. These pujas bring protection, peace,
...
export default Ujjain_Temple_Pujas;
