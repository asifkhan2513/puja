            ...
            <div className="card p-8">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-100 bg-white dark:bg-dark-50 text-black focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
