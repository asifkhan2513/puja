...
const Tula_Libra = () => {
  const details = {
    ...
    rulingPlanet: "Venus",
    element: "Air",
    luckyColor: "Pink, Light Blue, White",
    luckyNumber: "6, 9",
    description:
      "Libra individuals are balanced, charming, diplomatic, and lovers of harmony. Ruled by Venus, they enjoy beauty, relationships, creativity, and fairness. They seek peace and are excellent mediators in conflict situations.",
  };

  const dailyInsights = [
    "Relationships and partnerships get a boost today.",
    "A good day to make creative or aesthetic decisions.",
    "Avoid indecisiveness—trust your inner balance.",
  ];
