...
const Vrishchik_Scorpio = () => {
  const details = {
    ...
    luckyNumber: "9, 11",
    description:
      "Scorpio individuals are intense, intuitive, determined, and deeply emotional. They possess powerful willpower and are known for their loyalty and passion. Their mysterious aura and strong instincts help them succeed even in challenging situations.",
  };

  const dailyInsights = [
    "Emotional clarity helps you make better decisions today.",
    "A positive shift in relationships or partnerships is likely.",
    "Avoid overreacting—stay calm and composed.",
  ];
...
export default Vrishchik_Scorpio;
