...
const Meen_Pisces = () => {
  const details = {
    ...
    element: "Water",
    luckyColor: "Sea Green, Aqua, Lavender",
    luckyNumber: "7, 12",
    description:
      "Pisces individuals are intuitive, compassionate, artistic, and spiritually inclined. They possess deep emotional sensitivity and a natural desire to help others. Their imagination and creativity make them dreamers and visionaries.",
  };

  const dailyInsights = [
    "A peaceful day with opportunities for creativity.",
    "Someone may come to you for guidance—your intuition will help.",
    "Avoid overthinking; meditate or relax to stay balanced.",
  ];
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-amber-100 rounded-2xl shadow p-8 mb-10">
          <h3 className="text-2xl font-semibold text-amber-800 mb-4">About Pisces</h3>
