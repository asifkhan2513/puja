...
const Kark_Cancer = () => {
  const details = {
    ...
    rulingPlanet: "Moon",
    element: "Water",
    luckyColor: "White, Silver, Light Blue",
    luckyNumber: "2, 7",
    description:
      "Cancer individuals are emotional, intuitive, caring, and deeply connected to family. Ruled by the Moon, they experience strong emotions and possess nurturing qualities. They value security, comfort, and meaningful relationships.",
  };

  const dailyInsights = [
    "A good day to focus on emotional well-being.",
    "Family matters bring joy and harmony.",
    "Be cautious with financial decisions today.",
  ];
