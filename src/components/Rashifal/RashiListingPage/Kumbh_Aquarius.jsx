...
const Kumbh_Aquarius = () => {
  const details = {
    sign: "Kumbh (Aquarius)",
    dateRange: "January 20 – February 18",
    rulingPlanet: "Saturn & Uranus",
    element: "Air",
    luckyColor: "Blue, Black, Purple",
    luckyNumber: "4, 8",
    description:
      "Aquarius individuals are innovative, independent, intellectual, and humanitarian in nature. They value freedom and originality, often thinking ahead of their time. Their ideas and creativity make them natural problem-solvers.",
  };

  const dailyInsights = [
    "A great day for creative thinking and planning.",
    "Someone may support your goals unexpectedly.",
    "Avoid arguments and maintain calm in conversations.",
  ];
    ...
    <section className="py-16 bg-amber-50/40">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-amber-100 rounded-2xl shadow p-8 mb-10">
          <h3 className="text-2xl font-semibold text-amber-800 mb-4">About Aquarius</h3>
