...
const Mesh_Aries = () => {
  const details = {
    ...
    rulingPlanet: "Mars",
    element: "Fire",
    luckyColor: "Red, Scarlet, Bright shades",
    luckyNumber: "1, 9",
    description:
      "Aries individuals are bold, energetic, ambitious, and natural leaders. Ruled by Mars, they are action-oriented, courageous, and always ready to take initiative. Their enthusiasm inspires others, and they thrive in competitive environments.",
  };

  const dailyInsights = [
    "A great day to start new projects or take initiative.",
    "Financial gains are likely—stay alert for opportunities.",
    "Avoid impulsive decisions in relationships; stay calm.",
  ];
